    ...
    rag = LightRAG(
        ...
        embedding_func=EmbeddingFunc(
            ...
            func=lambda texts: openai_embed(
                texts=texts, model="intfloat/e5-mistral-7b-instruct", base_url="https://apps.aws-virginia-nbstg1.svc.singlestore.com:8000/modelasaservice/18ac5665-127d-4b8b-92a0-6d4ce65e2218/v1", api_key=os.environ["EMBEDDINGS_API_KEY"]
            ),
        ),
